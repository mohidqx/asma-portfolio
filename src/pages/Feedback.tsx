  ...
  if (submitted) {
    return (
      <div className="min-h-screen pt-24 flex items-center justify-center">
        <div className="glass-card rounded-3xl p-12 text-center max-w-md mx-6 animate-scale-up">
    ...
    <div className="min-h-screen pt-24">
      <section className="section-padding">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-center text-muted-foreground mb-12 animate-fade-up opacity-0 delay-100">
            Your feedback helps us improve. Tell us about your experience working with AM Marketing.
          </p>

          <form onSubmit={handleSubmit} className="glass-card rounded-3xl p-8 md:p-10 space-y-6 animate-fade-up opacity-0 delay-200">
            <div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-primary text-primary-foreground font-body font-semibold hover:scale-[1.02] transition-transform glow-gold disabled:opacity-50"
            >
